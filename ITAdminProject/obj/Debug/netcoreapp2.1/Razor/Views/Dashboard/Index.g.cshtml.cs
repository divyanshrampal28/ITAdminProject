#pragma checksum "C:\Users\DivyanshRampal\Documents\ITADMIN3\ITAdminProject\Views\Dashboard\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d19340cc9919dde05dccd85f808fe06876bce3cd"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d19340cc9919dde05dccd85f808fe06876bce3cd", @"/Views/Dashboard/Index.cshtml")]
...
#line hidden
            EndContext();
            BeginContext(21747, 84, true);
            WriteLiteral(",\r\n            datasets: [{\r\n                label: \'count\',\r\n                data: ");
            EndContext();
            BeginContext(21832, 68, false);
...
");
            EndContext();
            BeginContext(23240, 76, true);
            WriteLiteral("    });\r\n\r\n\r\n    const historyappend = document.getElementById(\"history\");\r\n");
            EndContext();
            BeginContext(23431, 4317, true);
        ...
        success: function (data) {
            ...
            for (let i = 0; i < list.length; i++) {
                ...
                if (item.categoryName.length == 0) {
                    ...
                    chld.inner");
            WriteLiteral(@"HTML = ""Category "" + item.categoryName + "" was "" + item.action + "" by "" + data[i];
